...
os.environ['MASTER_PORT'] = '43271'
os.environ['RANK'] = '0'
os.environ['WORLD_SIZE'] = '1'

def main():
  parser = argparse.ArgumentParser()
  parser.add_argument('--model', default="clip_vit_base_patch16_adapter12x384",type=str, required=True,
  ...
  parser.add_argument('--save_dir', type=str,default="output_dir/ucf/clip_vit_base_patch16_adapter12x384",
  ...
  parser.add_argument('--dataset', default="k400",type=str, required=True, choices=DATASETS.keys(),
  ...
  print("The port is in used:", os.environ['MASTER_PORT'])
  ...
  print("Cuda card can use num:",torch.cuda.device_count())
  ...
  for epoch in range(start_epoch, args.epochs):
    ...
    for step, (data, labels) in enumerate(metric_logger.log_every(dataloader_train, args.print_freq, header)):
      ...
      with ((torch.cuda.amp.autocast())):
        ...
        acc1_all=logits.topk(1, dim=1)[1] == labels.view(-1, 1)
